# 即梦 OmniHuman 1.5 视频生成

使用 TokenByte 调用 即梦 OmniHuman 1.5 视频生成接口

`POST` `https://api.tokenbyte.ai/api/v1/video/generation`

使用 TokenByte 统一视频任务接口调用 Jimeng 的OmniHuman 1.5 视频生成能力。模型名称请查看TokenByte支持的所有[AI 模型](https://tokenbyte.ai/models/),不要根据厂商官网名称自行推测。
